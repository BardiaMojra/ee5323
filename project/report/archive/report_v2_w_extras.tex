...
\author{Bardia~Mojra,~\IEEEmembership{Member,~IEEE,}
...
\begin{abstract}
%\boldmath
Manipulation of deformable linear objects (DLO's) or Kirchhoff's elastic rods has
brought much-needed attention to a category of open problems in robotics.
DLO is described as any elastic rod with relatively small diameter and large
